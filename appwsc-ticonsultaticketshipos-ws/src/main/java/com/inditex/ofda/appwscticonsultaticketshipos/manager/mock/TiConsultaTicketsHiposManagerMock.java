package com.inditex.ofda.appwscticonsultaticketshipos.manager.mock;
 ...
 */
public class TiConsultaTicketsHiposManagerMock implements TiConsultaTicketsHiposManager {

	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(TiConsultaTicketsHiposManagerMock.class);

	/**
	 * Instantiates a new ti consulta tickets hipos manager mock.
	 */
	public TiConsultaTicketsHiposManagerMock() {
	}
	...
	public GetTiendasByPaisISOyCadenaResponse obtenerTiendasByPaisISOyCadena(final GetTiendasByPaisISOyCadenaRequest request)
			throws GeneralServiceException{
		GetTiendasByPaisISOyCadenaResponse response = new GetTiendasByPaisISOyCadenaResponse();	
		response.setListaTiendas(rellenaListaTiendas());	
		return response;
	}
	
	/**
	 * Rellena lista tiendas.
	 *
	 * @return the list
	 */
	List <TiendasType> rellenaListaTiendas(){
		List <TiendasType> listaTiendas = new ArrayList<TiendasType>();
		TiendasType tienda1 = new TiendasType();
		tienda1.setIdCadena(2);
		tienda1.setIdPais(11);
		tienda1.setIdTienda(558);
		tienda1.setNombreCadena("Pull & Bear");
		tienda1.setNombreTienda("C.REAL-GENERAL AGUILERA");
		tienda1.setPais("ESPANA");
		tienda1.setPaisIso(724);
		TiendasType tienda2 = new TiendasType();
		tienda2.setIdCadena(2);
		tienda2.setIdPais(11);
		tienda2.setIdTienda(697);
		tienda2.setNombreCadena("Pull & Bear");
		tienda2.setNombreTienda("COR-MARINEDA CITY");
		tienda2.setPais("ESPANA");
		tienda2.setPaisIso(724);
		TiendasType tienda3 = new TiendasType();
		tienda3.setIdCadena(2);
		tienda3.setIdPais(11);
		tienda3.setIdTienda(700);
		tienda3.setNombreCadena("Pull & Bear");
		tienda3.setNombreTienda("T.REG.ESP.PB");
		tienda3.setPais("ESPANA");
		tienda3.setPaisIso(724);
