...
/**
 * The Class TicketHiposResponseOSB.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "", propOrder = {
    "contenidoTicket"
})
@XmlRootElement(name = "TicketHiposResponseOSB")
public class TicketHiposResponseOSB {
	...
	/**
	 * Instantiates a new ticket hipos response osb.
	 */
	public TicketHiposResponseOSB() {
		super();
	}
	 ...
	 */
	public TicketHiposResponseOSB(String contenidoTicket) {
		super();
	...
	public boolean equals(Object obj) {
		...
		TicketHiposResponseOSB other = (TicketHiposResponseOSB) obj;
	...
	public String toString() {
		...
		builder.append("TicketHiposResponseOSB [contenidoTicket=");
